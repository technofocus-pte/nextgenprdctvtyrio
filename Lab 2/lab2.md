...
| **✎ CORRECTED**                                                       |
|                                                                       |
| Earlier guidance called this a "green + New task button." The control |
| is the **+ New task** button at the top-left of the sidebar, it is    |
| not green. Use the label and position to find it.                     |
+-----------------------------------------------------------------------+
...
| **✎ CORRECTED**                                                       |
|                                                                       |
| The scheduling plan should not contain "propose resolutions for       |
| conflicts", that step belongs to the Exercise 1 conflict scan. If you |
| see it carried over, it\'s a leftover from the previous task; the     |
| relevant scheduling steps are attendee resolution, slot-finding, and  |
| event creation.                                                       |
+-----------------------------------------------------------------------+
...
| **● NOTE**                                                            |
|                                                                       |
| The original guide repeated the Exercise 3 screenshots several times  |
| in a block here. The duplicates have been removed; the unique         |
| load-summary views above are the complete set.                        |
+-----------------------------------------------------------------------+
